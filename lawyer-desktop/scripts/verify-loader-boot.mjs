...
try {
  ...
  if (profileRequire.resolve('lawyer-dsh-desktop/package.json') !== desktopManifest) {
  ...
  if (profileDirectoryRequire.resolve('lawyer-dsh-desktop/package.json') !== desktopManifest) {
  ...
  ctx = await boot(
    ...
    prepared.rootConfig,
    [{ insert: [
      { id: 'desktop-shell', name: 'lawyer-dsh-desktop' },
  ...
  if (desktopEntry?.options.name !== 'lawyer-dsh-desktop') {
