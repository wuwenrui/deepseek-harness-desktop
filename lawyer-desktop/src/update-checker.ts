/** Headless version checks against the public LawyerDesk release service. */
...
/** Public endpoint returning the latest LawyerDesk version for a requested channel. */
...
/**
 * Check the fixed LawyerDesk version endpoint for a release in one channel.
