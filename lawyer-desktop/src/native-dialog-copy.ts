...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  ...
  zh: {
    ...
    restart: '重启律衡',
    dismiss: '关闭',
    updateAvailableTitle: '律衡有可用更新',
    updateAvailableMessage: version => `律衡 ${version} 已可用。`,
    ...
    tryAgainLater: '请稍后重试。',
    upToDateTitle: '律衡已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: '律衡更新已下载',
    updateReady: version => `律衡 ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的律衡，然后重新打开。',
    windowsInstallQuestion: '现在重启律衡并运行安装程序？',
    ...
    updateInstalled: version => `律衡 ${version} 已安装。`,
