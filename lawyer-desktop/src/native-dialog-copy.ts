...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    installStableAlongsideBeta: 'Install the stable edition alongside LawyerCopilot? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
  ...
  zh: {
    ...
    installStableAlongsideBeta: '是否同时安装稳定版？LawyerCopilot 将继续保留。',
    download: '下载',
    later: '稍后',
