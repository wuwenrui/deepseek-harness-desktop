...
const COPY: Record<DesktopLocale, DesktopNativeCopy> = {
  en: {
    ...
    dismiss: 'Dismiss',
    updateAvailableTitle: 'LawyerDesk Update Available',
    updateAvailableMessage: version => `LawyerDesk ${version} is available.`,
    downloadUpdate: 'Download this update now?',
    installStableAlongsideBeta: 'Install the stable edition alongside LawyerDesk? The Beta app will remain installed.',
    download: 'Download',
    later: 'Later',
    updateCheckFailedTitle: 'Unable to Check for Updates',
    updateCheckFailedMessage: 'Could not retrieve update information.',
    tryAgainLater: 'Please try again later.',
    upToDateTitle: 'LawyerDesk Is Up to Date',
    ...
    updateDownloadedTitle: 'LawyerDesk Update Downloaded',
    updateReady: version => `LawyerDesk ${version} is ready to install.`,
    macInstallInstructions: 'The disk image has opened. Replace LawyerDesk in Applications, then reopen it.',
    windowsInstallQuestion: 'Restart LawyerDesk and run the installer now?',
    ...
    updateInstalled: version => `LawyerDesk ${version} has been installed.`,
  ...
  zh: {
    ...
    restart: '重启律师 AI 工作台',
    dismiss: '关闭',
    updateAvailableTitle: '律师 AI 工作台有可用更新',
    updateAvailableMessage: version => `律师 AI 工作台 ${version} 已可用。`,
    downloadUpdate: '现在下载此更新？',
    installStableAlongsideBeta: '是否同时安装稳定版？LawyerDesk 将继续保留。',
    download: '下载',
    later: '稍后',
    updateCheckFailedTitle: '无法检查更新',
    updateCheckFailedMessage: '未能获取更新信息。',
    tryAgainLater: '请稍后重试。',
    upToDateTitle: '律师 AI 工作台已是最新版本',
    upToDateMessage: '当前已是最新版本。',
    installedVersion: version => `当前版本：${version}`,
    installerUnavailable: '当前版本不支持在应用内下载安装包。',
    updateDownloadedTitle: '律师 AI 工作台更新已下载',
    updateReady: version => `律师 AI 工作台 ${version} 已可安装。`,
    macInstallInstructions: '磁盘映像已打开。请替换“应用程序”中的律师 AI 工作台，然后重新打开。',
    windowsInstallQuestion: '现在重启律师 AI 工作台并运行安装程序？',
    ...
    updateInstalled: version => `律师 AI 工作台 ${version} 已安装。`,
