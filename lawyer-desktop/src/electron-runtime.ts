...
/** Native adapter used by the LawyerDesk launcher and owned by its Cordis shell plugin. */
  ...
  private buildTrayTemplate(spec: DesktopShellSpec): Electron.MenuItemConstructorOptions[] {
    ...
    template.push(
      { type: 'separator' },
      {
        ...
        enabled: false, // The managed product keeps one native presentation; Agent presets remain selectable.
