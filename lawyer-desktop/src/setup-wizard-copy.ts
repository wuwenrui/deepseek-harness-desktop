...
const COPY: Record<DesktopLocale, DesktopSetupWizardCopy> = {
  en: {
    ...
    beta: 'Beta',
    title: 'Set up LawyerDesk',
    profile: 'Profile',
    welcomeTitle: 'Welcome to LawyerDesk',
    ...
    communityMarketBody: 'The open market built into LawyerDesk, including custom data sources.',
    ...
    startUsing: 'Start using LawyerDesk',
  ...
  zh: {
    ...
    communityMarket: 'dsh-community-market',
    communityMarketBody: '律师 AI 工作台内置的开放市场，并支持自定义数据源。',
    dshMarket: 'dsh-market',
