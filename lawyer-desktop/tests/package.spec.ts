...
describe('published package surface', () => {
  ...
  it('separates unsigned smoke packaging from the signed macOS release', () => {
    ...
    expect(workspaceManifest.scripts?.['dist:mac:beta'])
      .toBe('yarn workspace dsh-community-market build && yarn workspace lawyer-dsh-desktop dist:mac')
    expect(workspaceManifest.scripts?.['dist:mac-smoke:beta'])
      .toBe('yarn workspace dsh-community-market build && yarn workspace lawyer-dsh-desktop dist:mac-smoke')
    expect(workspaceManifest.scripts?.['dist:win:beta'])
      .toBe('yarn workspace dsh-community-market build && yarn workspace lawyer-dsh-desktop dist:win')
    expect(workspaceManifest.scripts?.['dist:win-portable:beta'])
      .toBe('yarn workspace dsh-community-market build && yarn workspace lawyer-dsh-desktop dist:win-portable')
