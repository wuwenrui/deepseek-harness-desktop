...
describe('managed Desktop identity and profile admission', () => {
  ...
  it.each(['@lawyer-dsh/lawyer-platform', '@lawyer-dsh/market', '@lawyer-dsh/lawyer-brand', '@changfenhuang/dsh-genui', 'dsh-better-sidebar', '@deepseek-ai/dsh-experimental-agent-team-profile', '@deepseek-ai/dsh-experimental-agent-team-web-profile'])('does not let restore remove %s', name => {
