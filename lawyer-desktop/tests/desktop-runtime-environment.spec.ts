...
function options(
  ...
  return {
    ...
    appExecutable: platform === 'win32'
      ? 'C:\\Program Files\\DSH 100% Desktop\\LawyerDesk.exe'
      : "/Applications/DSH O'Brien.app/Contents/MacOS/LawyerDesk",
    pnpmBinPath: platform === 'win32'
      ? 'C:\\Program Files\\LawyerDesk\\resources\\app.asar.unpacked\\node_modules\\pnpm\\bin\\pnpm.mjs'
...
describe('desktop Host dsh runtime', () => {
  it('content-addresses Windows DSH shims and reuses an exact generation', () => {
    ...
    const runtimeOptions = {
      ...
      appExecutable: 'C:\\Program Files\\LawyerDesk\\LawyerDesk.exe',
      dshBootstrapPath: 'C:\\Program Files\\LawyerDesk\\resources\\app.asar\\desktop-cli.js',
      profileName: 'web',
