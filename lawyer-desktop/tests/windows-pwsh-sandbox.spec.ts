...
const adaptation: WindowsAclAdaptation = {
  platform: 'win32',
  electron: true,
  execPath: 'C:\\Program Files\\LawyerDesk\\LawyerDesk.exe',
  upstreamRunner: 'C:\\Program Files\\LawyerDesk\\resources\\app.asar\\runner.js',
  trampoline: 'C:\\Program Files\\LawyerDesk\\resources\\app.asar\\desktop-runner.js',
}
